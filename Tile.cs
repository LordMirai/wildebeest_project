...
namespace Chess
{
    ...
    public partial class Tile : UserControl
    {
        ...
        public Color TileColor()
        {
            ...
            {
                return ColorTranslator.FromHtml("#339933"); // Replace with your desired hex value
            }
            else
            {
                return ColorTranslator.FromHtml("#CCCC11"); // Replace with your desired hex value
            }
        }
        ...
        public static Dictionary<string, Image> PieceImages = new Dictionary<string, Image> {
            ...
            { "BWildebeest",Properties.Resources.BWildebeest},
            { "BCamel",Properties.Resources.BCamel},
            ...
            { "WWildebeest",Properties.Resources.WWildebeest},
            { "WCamel",Properties.Resources.WCamel},
            { "EMPTY",null }
        };
    }
